...
public class PCF_ClearQueue {
  ...
  public static final String sccsid = "@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=MQJavaSamples/pcf/PCF_ClearQueue.java"; //$NON-NLS-1$
  ...
  public static void ClearQueue(PCF_CommonMethods pcfCM) throws MQException, PCFException,
    ...
    if (pcfCM.client) {
      ...
      Hashtable<String, Comparable> parms = new Hashtable<String, Comparable>(8);
