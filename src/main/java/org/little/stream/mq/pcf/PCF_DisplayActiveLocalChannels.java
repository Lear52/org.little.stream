...
public class PCF_DisplayActiveLocalChannels {
  ...
  public static final String sccsid = "@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=MQJavaSamples/pcf/PCF_DisplayActiveLocalChannels.java"; //$NON-NLS-1$
