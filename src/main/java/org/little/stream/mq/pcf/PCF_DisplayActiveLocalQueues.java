...
public class PCF_DisplayActiveLocalQueues {
  ...
  public static final String sccsid = "@(#) MQMBID sn=p750-004-140807 su=_pY8W4B4HEeS1ypf5zzZGLw pn=MQJavaSamples/pcf/PCF_DisplayActiveLocalQueues.java"; //$NON-NLS-1$
